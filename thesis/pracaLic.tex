...
Do przeprowadzenia eksperymentu niezbędny jest \emph{Fine-Tuning} architektury \emph{ResNet-18} poprzez zamrożenie wszystkich warstw, odblokowanie warstw trzeciej i czwartej oraz wymianę oryginalnej warstwy klasyfikatora na nową, redukującą wektor cech do 10 wymiarów, w pełni odpowiadającą liczbie klas w zbiorze \emph{EuroSat}. Dzięki temu warstwy trzecia i czwarta uczą się specyficznych tekstur ze zdjęć satelitarnych, zachowując przy tym wiedzę o ogólnych kształtach.
