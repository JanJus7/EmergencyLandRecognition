...
W \emph{ResNet-18} zostały zaimplementowane połączenia skrótowe, omijające nieliniowe transformacje.\cite{he_resnet} Dzięki temu, w porównaniu do poprzedników, architektura ta eliminuje problem zanikającego gradientu. Problem ten powoduje zatrzymanie procesu optymalizacji wag. W porównaniu do modeli o większej liczbie warstw jak \emph{ResNet-34} czy \emph{ResNet-152}, \emph{ResNet-18} dociera do poprawnych rozwiązań szybciej, kosztem precyzji rozwiązań. Podczas sytuacji awaryjnej w samolocie liczy się jednak każda sekunda. Lepiej uzyskać mniej precyzyjne rozwiązanie w krótkim wymiarze czasowym, niż ryzykować utratą czasu podczas oczekiwania na zakończenie analizy materiału.
